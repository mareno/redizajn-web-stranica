...
$outgoingServerAddress      = 'mail.mareno-dizajn.com'; // Consult your hosting provider.
...
$sendingAccountUsername     = 'admin@mareno-dizajn.com';
$sendingAccountPassword     = 'p@55w0rd';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'admin@mareno-dizajn.com'; // REQUIRED value.
$recipientName              = 'Enes S.';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'A message from GitHub Website'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'Redizajn web stranica';                // REQUIRED value. This is used when a name or email is not collected from the website form

$timeZone					= 'Zagreb/Hrvatska';         // OPTIONAL, but some servers require this to be set. 
